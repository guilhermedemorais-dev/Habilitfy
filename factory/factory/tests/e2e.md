...
### Artefatos esperados
- Relatorio: `factory/tests/reports/qa-e2e-browser-audit/<timestamp>/report.md`
- Evidencias: screenshots/logs em `factory/tests/reports/qa-e2e-browser-audit/<timestamp>/artifacts/`
