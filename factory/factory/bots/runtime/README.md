...
```
python factory/bots/runtime/cli.py run qa-e2e-browser-audit --task "Browser audit baseUrl=https://app.exemplo.com" --workspace "/path/to/workspace"
```
...
- Browser audit requer `factory/config/mcp.toml` com `[chrome_devtools]` habilitado (ou `FACTORY_MCP_CONFIG`).
