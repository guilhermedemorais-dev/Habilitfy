# FILE: factory/bots/qa-e2e-browser-audit.md
...
- `factory/libs/mcp/servers/chrome-devtools.md`
...
- Relatorio final em Markdown.
  - Caminho canonico sugerido: `factory/tests/reports/qa-e2e-browser-audit/<timestamp>/report.md`
- Anexos (screenshots/logs) em subpasta:
  - `factory/tests/reports/qa-e2e-browser-audit/<timestamp>/artifacts/`
