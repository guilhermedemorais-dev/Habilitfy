...
## O que e
Runtime e o executor local de bots (Python + CLI). Ele **carrega contratos** em `factory/bots/*.md` e executa tarefas com base no contexto.
...
## Outputs e logs
- Saida canonica: `factory/bots/runtime/out/<timestamp>/<bot>/`
- Log sugerido: `factory/bots/runtime/out/runtime.log`
