...
- Sempre ler `factory/context/INDEX.md` antes de qualquer planejamento ou execucao.
- Se o INDEX nao existir, interromper e registrar gap em `factory/context/core/gaps.md`.

## Politica de escrita
- Por padrao, escrever apenas dentro de `/factory`.
- Escrita fora de `/factory` so e permitida com workspace explicito e autorizacao.
...
- Se algo nao estiver definido, registrar em `factory/context/core/gaps.md` e parar.

## Politica de gaps
- Qualquer ambiguidade, conflito ou falta de informacao deve ser registrada em `factory/context/core/gaps.md`.
