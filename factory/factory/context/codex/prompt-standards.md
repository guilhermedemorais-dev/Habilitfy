...
- Regras: ler `factory/context/INDEX.md`, nao inventar requisitos, registrar gaps em `factory/context/core/gaps.md`.
...
- Sempre indicar o caminho completo do arquivo alvo (ex.: `factory/...`).
...
- Ignorar gaps ou nao registrar em `factory/context/core/gaps.md`.
