...
7) Deploy: ✅ realizado v1.1.0 (Hostinger app Node).
   - [x] Configuração de envs e entry point `server.cjs`.
   - [x] Hotfix v1.1.0-fix.1: Botão Google e logs auth.
   - [ ] Monitoramento de erros 400 (API Instructors).
